...
def main():
    ...
    pyglet.font.add_file("Ubuntu.ttf")
    pyglet.font.add_file("Shanti.ttf")
    ...
    def load_frame1():
        ...
        # create logo widget
        logo_img = ImageTk.PhotoImage(file="recipelogo.png")
    ...
    def load_frame2():
        ...
        # create logo widget
        logo_img = ImageTk.PhotoImage(file="recipelogo2.png")
